...
export interface ApiFooterFooter extends Schema.CollectionType {
  ...
  attributes: {
    ...
    underlinks: Attribute.Component<'footer.underlink', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiNavBarNavBar extends Schema.CollectionType {
  ...
  attributes: {
    tab: Attribute.Component<'nav-bar.nav-bar-tab', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiNavBarItemNavBarItem extends Schema.CollectionType {
  ...
  info: {
    singularName: 'nav-bar-item';
    pluralName: 'nav-bar-items';
...
export interface ApiNavBarListNavBarList extends Schema.CollectionType {
  collectionName: 'nav_bar_lists';
  info: {
    singularName: 'nav-bar-list';
    pluralName: 'nav-bar-lists';
  ...
  attributes: {
    ...
    icon: Attribute.Media;
    navbaritems: Attribute.Relation<
      'api::nav-bar-list.nav-bar-list',
      'oneToMany',
      'api::nav-bar-item.nav-bar-item'
    >;
    displayNameInNavBarTab: Attribute.String & Attribute.Private;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
